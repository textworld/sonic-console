...
const { HaloRestAPIClient } = require('@halo-dev/admin-api')

class CustomAdminApiClient {
  constructor(client) {
    this.client = client.buildHttpClient()
    this._scrap = new clients.ScrapClient(this.client)
  }
...
const apiClient = new CustomAdminApiClient(haloRestApiClient)
